...
import pygame
import numpy as np
from statistic_window import start
...
with open("project\\settings.txt") as file:
...
def simulation():
    ...
    for j, i in coordinates:
        ...
        if j + 1 > ROWS - 1:
            ...
            pass
        elif i + 1 > ROWS - 1 and j + 1 > ROWS - 1:
            pass
        else:
            grid[j + 1][i + 1] = 1
        if j + 1 > ROWS - 1:
            ...
            pass
        elif i + 2 > ROWS - 1 and j + 1 > ROWS - 1:
            pass
        else:
            grid[j + 1][i + 2] = 1
        if j + 1 > ROWS - 1:
            ...
            pass
        elif i + 3 > ROWS - 1 and j + 1 > ROWS - 1:
            pass
        else:
            grid[j + 1][i + 3] = 1
        if j + 2 > ROWS - 1:
        ...
        if j + 2 > ROWS - 1:
            ...
            pass
        elif i + 1 > ROWS - 1 and j + 2 > ROWS - 1:
            pass
        else:
            grid[j + 2][i + 1] = 1
        if j + 2 > ROWS - 1:
            ...
            pass
        elif i + 2 > ROWS - 1 and j + 2 > ROWS - 1:
            pass
        else:
            grid[j + 2][i + 2] = 1
        if j + 2 > ROWS - 1:
            ...
            pass
        elif i + 3 > ROWS - 1 and j + 2 > ROWS - 1:
            pass
        else:
            grid[j + 2][i + 3] = 1
        if j + 3 > ROWS - 1:
    ...
    for i, j in coordinates_lakes:
        state = grid[i][j]
        neighbours_list = get_neighbours_mode(i, j)
        if (i + 3) < ROWS - 2 and (j + 3) < ROWS - 2 and (i - 3) >= 0 and (j - 3) >= 0:
